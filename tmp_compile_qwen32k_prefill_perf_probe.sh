...
# Keep the shape set narrow for the perf question: 16k cold prompt with
# chunked prefill. Zero-prefix CTE is added by the compile helper.
CTE_BUCKETS=(3072)
PREFIX_BUCKETS=(4096 8192 16384)
PAIR_ARGS=(3072:4096 3072:8192 3072:16384)
TKG_BUCKETS=(512 16384 16640 32768)

BASE="qwen36_27b_32768_fp8_full_lmheadfp8_kvfp8_hybrid_apc_nki_prefillperf_probe32k_gdnrec${GDN_RECURRENT_CACHE_DTYPE}_sampletokens_outlogits_b256_cte3072_pfx16k_${PREFIX_CTE_ATTENTION_BACKEND}${PREFIX_CTE_ATTENTION_SEGMENT_SIZE}_solve${QWEN36_DELTANET_SOLVE_BLOCK_SIZE}_apfx${QWEN36_DELTANET_SOLVE_ACTIVE_PREFIX_K}_lnc2_slots64_async_cteargmaxsafe_${TS}"
ART="${ART_ROOT}/${BASE}"
WORK="${ART_ROOT}/_nxd_model_workdir_32768_fp8_full_lmheadfp8_kvfp8_nki_prefillperf_probe32k_gdnrec${GDN_RECURRENT_CACHE_DTYPE}_sampletokens_outlogits_b256_cte3072_${PREFIX_CTE_ATTENTION_BACKEND}${PREFIX_CTE_ATTENTION_SEGMENT_SIZE}_solve${QWEN36_DELTANET_SOLVE_BLOCK_SIZE}_apfx${QWEN36_DELTANET_SOLVE_ACTIVE_PREFIX_K}_lnc2_${TS}"
