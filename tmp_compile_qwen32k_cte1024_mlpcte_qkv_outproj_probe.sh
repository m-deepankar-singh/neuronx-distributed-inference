...
PAIR_ARGS=(1024:256 1024:512 1024:1024 1024:2048 1024:4096 1024:8192 1024:16384)
TKG_BUCKETS=(512 16384 16640 32768)

BASE="qwen36_27b_32768_fp8_full_lmheadfp8_kvfp8_hybrid_apc_nki_decode_stable_probe32k_gdnrec${GDN_RECURRENT_CACHE_DTYPE}_sampletokens_outlogits_b256_cte1024_pfx16k_slots64_async_cteargmaxsafe_skip1024pfx_mlpcte_qkvnki_outprojnki_${TS}_scan2"
ART="${ART_ROOT}/${BASE}"
WORK="${ART_ROOT}/_nxd_model_workdir_32768_fp8_full_lmheadfp8_kvfp8_nki_decode_stable_probe32k_gdnrec${GDN_RECURRENT_CACHE_DTYPE}_sampletokens_outlogits_b256_cte1024_cteargmaxsafe_skip1024pfx_mlpcte_qkvnki_outprojnki_${TS}_scan2"
