...
BASE="qwen36_27b_256k_fp8_full_lmheadfp8_kvfp8_hybrid_apc_nki_decode_${VARIANT_TAG}_${RECURRENT_DTYPE_TAG}_sampletokens_b256_cte256_512_pfx16k_slots64_async_${TS}"
ART="${ART_ROOT}/${BASE}"
WORK="${ART_ROOT}/_nxd_model_workdir_256k_fp8_full_lmheadfp8_kvfp8_nki_decode_${VARIANT_TAG}_${RECURRENT_DTYPE_TAG}_sampletokens_b256_${TS}"
...
printf "%s\n" \
  ...
  "KERNELS=decode_deltanet,split_qkv_tkg,output_gate_tkg,mlp_tkg_nki,quantized_mlp" \
