...
BASE="qwen36_${SEQ_TAG}_fp8_${FP8_EXCLUDE_TAG}_${LM_HEAD_TAG}_${LINEAR_ATTN_GATE_TAG}_${KV_CACHE_TAG}_${QKV_KERNEL_TAG}_${OUT_PROJ_KERNEL_TAG}_${PREFIX_CTE_ATTENTION_BACKEND}${PREFIX_CTE_ATTENTION_SEGMENT_SIZE}_gdnseg${QWEN36_DELTANET_FUSED_SEGMENT_TOKENS}_cte${CTE_TAG}_${PFX_TAG}_slots${MAX_GDN_CHECKPOINT_SLOTS}_${TS}_${SOLVE_TAG}"
ART="${ART_ROOT}/${BASE}"
WORK="${ART_ROOT}/_nxd_work_${SEQ_TAG}_fp8_${FP8_EXCLUDE_TAG}_${LM_HEAD_TAG}_${LINEAR_ATTN_GATE_TAG}_${KV_CACHE_TAG}_${QKV_KERNEL_TAG}_${OUT_PROJ_KERNEL_TAG}_${PREFIX_CTE_ATTENTION_BACKEND}${PREFIX_CTE_ATTENTION_SEGMENT_SIZE}_gdnseg${QWEN36_DELTANET_FUSED_SEGMENT_TOKENS}_cte${CTE_TAG}_${TS}_${SOLVE_TAG}"
