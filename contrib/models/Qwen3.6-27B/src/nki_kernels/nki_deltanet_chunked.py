...
def deltanet_chunk_step(
    ...
    # ============================================================
    # Measurement-only solve isolation: N = I.
    #
    # This branch intentionally bypasses N = inv(I - A_mat) to measure how much
    # of CTE time is spent in the stable triangular solve. It is not
    # mathematically correct and must not be used for production artifacts.
    # ============================================================
