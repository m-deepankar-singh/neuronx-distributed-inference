...
def test_logit_accuracy(tokenizer):
    ...
    # Generate on Neuron to capture the first generated token's logits.
    ...
    gen_model.generation_config.transformers_version = transformers.__version__
    logit_gen_config.transformers_version = transformers.__version__
    outputs = gen_model.generate(
        input_ids,
    ...
    neuron_first = neuron_scores[0, 0, :].float()
