...
"""Unit tests for Qwen3.5-4B HF-to-NxDI weight conversion.
...
class TestVLPrefixStripping(unittest.TestCase):
    ...
    def test_tied_embeddings_synthesize_lm_head(self):
        config = _make_mini_config()
        ...
        torch.testing.assert_close(result["lm_head.weight"], embed)
