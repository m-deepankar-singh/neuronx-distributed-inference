...
55. Runtime verdict to next speed-slice decision helper.
   ...
   - The output JSON includes current artifact/base, current `SPEED_SLICE`, coherence/log-scan verdict, speed gate, mean prefill tok/s, `decision`, optional `next_speed_slice`, and the required flags for that next slice.
   ...
   - Verification passed locally: `python3 -m py_compile validation_scripts/qwen36_speed_slice_decision.py test/unit/scripts/test_qwen36_speed_slice_decision.py validation_scripts/qwen36_validation_tool_manifest.py test/unit/scripts/test_qwen36_validation_tool_manifest.py`; `python3 -m pytest test/unit/scripts/test_qwen36_speed_slice_decision.py test/unit/scripts/test_qwen36_validation_tool_manifest.py` (`13 passed`); `python3 -m pytest test/unit/scripts` (`67 passed`); `python3 validation_scripts/qwen36_speed_slice_decision.py --help`; manifest build for 12 files; and manifest verify with `mismatch_count=0`.
